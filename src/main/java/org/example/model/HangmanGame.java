...
import static org.example.model.HangmanGamesStatus.*;

public class HangmanGame {

    private final static int HANGMAN_INITIAL_LINE_LENGTH = 9;
    private final static int HANGMAN_INITIAL_LINE_LENGTH_WHIT_LINE_SEPARATOR = 10;
    ...
    private List<Character> failAttempts = new ArrayList<>();

    private String hangman;
    private HangmanGamesStatus hangmanGameStatus;
    ...
    public HangmanGame(final List<HangmanChar> characters){
        ...
        this.lineSize =  HANGMAN_INITIAL_LINE_LENGTH_WHIT_LINE_SEPARATOR + whiteSpaces.length();
    ...
    public HangmanGamesStatus getHangmanGameStatus() {
